...
- [Category list Page ,Expenses list Page]
...
- Open the [Repository Link]https://github.com/41hulk/budget-app.git of this project in GitHub.
...
- https://github.com/41hulk/budget-app.git

  Navigate to the created folder.

- Initialize your project with Git.
- Make sure that your project has Postgres database set up.
- Run rails server and visi thttp://127.0.0.1:3001/ in your browser!
